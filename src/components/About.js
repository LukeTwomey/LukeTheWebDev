...
export const About = () => {
  return (
    <main>
      ...
      <p>
        After graduating with a first in BSc(Hons) Computing Studies in 2006, I
        began working for a London software company, initially on the client
      ...
      <p>
        Above all else, I craved the impossible dream - to enjoy what I did for
        a living! Was it just a mythical goal only reserved for sports people
        and fighter pilots?
      </p>
      <p>
        I have always been a very logical person, methodical and well organised,
        with a talent for problem solving and a high attention to detail. I had
        always known I enjoyed development - right from when I first started
        programming in university. It was finally becoming clearer to me in
        which direction I should be heading.
      </p>
      <p>
      ...
      <p>
        ...
        examples of these tools <a href="/portfolio">in my portfolio</a>. One is
        a Chrome extension called <a href="/asset-eater-2">Asset Eater</a>,
        which bulk downloaded the assets for our banners from DoubleClick. The
        other is <a href="/tstack">tStack</a>, an email component generator used
        by the email development team. My role also involved training and
      ...
      <p>
        ...
        frameworks (E.G. React with Redux) and each thoroughly developed through
        code reviews, automated testing and a TDD approach. We will soon be
        moving to Azure Kubernetes Service (AKS) for deployment to further
        improve our product.
      </p>
      <p>So far I've managed to pick up the following skills along the way.</p>
    </main>
  );
};
