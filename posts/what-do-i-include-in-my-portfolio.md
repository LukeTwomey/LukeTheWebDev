...
- Just testing this quick list here
  - And now a sub-bullet for this one!
- Another bullet here with important stuff
- And you just know there's going ot be a third...

This word coming up is _important_
...
I'm using this within a paragraph `npm install react-syntax-highlighter --save` and I'm keeping on writing here.
